...
public class PostController {
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "구직 글 수정 성공"),
	...
	@ApiResponses({ @ApiResponse(responseCode = "204", description = "구직 글 삭제 성공"),
			@ApiResponse(responseCode = "404", description = "구직 글을 찾을 수 없음") })
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "구인 글 수정 성공"),
	...
	@ApiResponses({ @ApiResponse(responseCode = "204", description = "구인 글 삭제 성공"),
			@ApiResponse(responseCode = "404", description = "구인 글을 찾을 수 없음") })
